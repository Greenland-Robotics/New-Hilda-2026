...
public class ReverseIntake implements Command {
    private final OpModeBase robot = OpModeBase.INSTANCE;

    @Override
    public void init() {
        robot.intakeMotor.setPower(Constants.Intake.REVERSE_POWER);
    }
    ...
    public boolean isFinished() {
        return true; // fire and forget - intake runs until stopped
    }
}
