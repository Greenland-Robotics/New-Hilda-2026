...
public abstract class OpModeBase extends LinearOpMode {
    ...
    protected CommandRunner commandRunner;package gcsrobotics.control;
...
import gcsrobotics.vertices.CommandRunner;
    ...
    public abstract class OpModeBase extends LinearOpMode {
        public static volatile gcsrobotics.control.OpModeBase INSTANCE;
        public Follower follower;
    ...
    private void initHardware() {
      ...
      //  shootSensor.setMode(DigitalChannel.Mode.INPUT); // configure as input for beam-break
       //pin transferSensor = hardwareMap.get(DistanceSensor.class, "transferSensor"); // TODO: confirm type
    }
