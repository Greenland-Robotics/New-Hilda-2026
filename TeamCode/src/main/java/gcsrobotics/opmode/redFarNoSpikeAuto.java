...
// ═══════════════════════════════════════════════════════════════════════════
    ...
    @Autonomous(name = "RedFarNoSpikeAuto")
    public class redFarNoSpikeAuto extends AutoBase {
        ...
        gcsrobotics.opmode.redFarNoSpikeAuto.Paths paths;
        ...
        protected void initialize() {
            ...
            paths = new gcsrobotics.opmode.redFarNoSpikeAuto.Paths(follower);
        ...
        protected void buildCommands() {
            commandRunner = new CommandRunner(
                    new SeriesCommand(
                            ...
                            new InstantCommand(() -> tracker.record("CORNER_APPROACH", follower.getPose(), gcsrobotics.opmode.redFarNoSpikeAuto.Paths.CORNER_APPROACH_POSE)),

                            new InstantCommand(() -> follower.setMaxPower(INTAKE_SPEED)),
                            new FollowPath(paths.CornerBumpBack),
                            new InstantCommand(() -> tracker.record("CORNER_BUMP_BACK", follower.getPose(), gcsrobotics.opmode.redFarNoSpikeAuto.Paths.CORNER_BUMP_BACK_POSE)),
                            new FollowPath(paths.CornerBumpForward),
                            new InstantCommand(() -> tracker.record("CORNER_BUMP_FWD", follower.getPose(), gcsrobotics.opmode.redFarNoSpikeAuto.Paths.CORNER_BUMP_FWD_POSE)),
                            new FollowPath(paths.CornerAdjust),
                            new InstantCommand(() -> tracker.record("CORNER_ADJUST", follower.getPose(), gcsrobotics.opmode.redFarNoSpikeAuto.Paths.CORNER_ADJUST_POSE)),
                            ...
                            new InstantCommand(() -> tracker.record("CORNER2_APPROACH", follower.getPose(), gcsrobotics.opmode.redFarNoSpikeAuto.Paths.CORNER_APPROACH_POSE)),

                            new InstantCommand(() -> follower.setMaxPower(INTAKE_SPEED)),
                            new FollowPath(paths.CornerBumpBack),
                            new InstantCommand(() -> tracker.record("CORNER2_BUMP_BACK", follower.getPose(), gcsrobotics.opmode.redFarNoSpikeAuto.Paths.CORNER_BUMP_BACK_POSE)),
                            new FollowPath(paths.CornerBumpForward),
                            new InstantCommand(() -> tracker.record("CORNER2_BUMP_FWD", follower.getPose(), gcsrobotics.opmode.redFarNoSpikeAuto.Paths.CORNER_BUMP_FWD_POSE)),
                            new SleepCommand(BUMP_PAUSE_MS),
                            new FollowPath(paths.CornerAdjust),
                            new InstantCommand(() -> tracker.record("CORNER2_ADJUST", follower.getPose(), gcsrobotics.opmode.redFarNoSpikeAuto.Paths.CORNER_ADJUST_POSE)),
                            ...
                            new InstantCommand(() -> tracker.record("PARK_END", follower.getPose(), gcsrobotics.opmode.redFarNoSpikeAuto.Paths.PARK_POSE)),
        ...
        static class Paths {
            ...
            public PathChain CornerApproach3;  // departs from SHOOT_POSE_RETURN_2 (61°)
            ...
            public PathChain CornerReturn3;    // arrives at SHOOT_POSE_RETURN_3 (62°)
            ...
            public Paths(Follower follower) {
                ...
                // ── Corner Cycle 3 — departs from SHOOT_POSE_RETURN_2 (61°) ──
                CornerApproach3 = follower.pathBuilder()
                        .addPath(new BezierLine(SHOOT_POSE_RETURN_2, CORNER_APPROACH_POSE))
                        .setLinearHeadingInterpolation(SHOOT_POSE_RETURN_2.getHeading(), CORNER_APPROACH_POSE.getHeading())
                        .build();

                // ── Corner Return 3 — arrives at SHOOT_POSE_RETURN_3 (62°) ──
