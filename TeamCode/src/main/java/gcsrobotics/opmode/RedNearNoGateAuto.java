...
// ═══════════════════════════════════════════════════════════════════════════
    ...
    @Autonomous(name = "1RED NEAR AUTO- NO GATE")
    public class RedNearNoGateAuto extends AutoBase {
        ...
        protected void initialize() {
            ...
            paths = new gcsrobotics.opmode.RedNearAutoGate.Paths(follower);
        ...
        protected void buildCommands() {
            commandRunner = new CommandRunner(
                    new SeriesCommand(
                            ...
                            new InstantCommand(() -> tracker.record("SPIKE_APPROACH", follower.getPose(), gcsrobotics.opmode.RedNearAutoGate.Paths.SPIKE_APPROACH_POSE)),

                            new InstantCommand(() -> follower.setMaxPower(INTAKE_SPEED)),
                            new FollowPath(paths.SpikeSweep),
                            new InstantCommand(() -> tracker.record("SPIKE_SWEEP", follower.getPose(), gcsrobotics.opmode.RedNearAutoGate.Paths.SPIKE_SWEEP_POSE)),
                            ...
                            new InstantCommand(() -> tracker.record("COLLECT2_OUT", follower.getPose(), gcsrobotics.opmode.RedNearAutoGate.Paths.COLLECT2_OUT_POSE)),

                            new InstantCommand(() -> follower.setMaxPower(INTAKE_SPEED)),
                            new FollowPath(paths.Collect2Sweep),
                            new InstantCommand(() -> tracker.record("COLLECT2_SWEEP", follower.getPose(), gcsrobotics.opmode.RedNearAutoGate.Paths.COLLECT2_OUT_POSE)),

                            new InstantCommand(() -> follower.setMaxPower(NORMAL_SPEED)),
                            new FollowPath(paths.Collect2End),
                            new InstantCommand(() -> tracker.record("COLLECT2_END", follower.getPose(), gcsrobotics.opmode.RedNearAutoGate.Paths.COLLECT2_END_POSE)),
                            ...
                            new InstantCommand(() -> tracker.record("PARK_END", follower.getPose(), gcsrobotics.opmode.RedNearAutoGate.Paths.PARK_POSE))
                    )
            );
        }
        ...
        public static class Paths {
            ...
            static final Pose SPIKE_APPROACH_POSE    = new Pose(100.983, 78, Math.toRadians(0));
            static final Pose SPIKE_SWEEP_POSE       = new Pose(125.000, 78, Math.toRadians(0));
            static final Pose SPIKE_COLLECT_END_POSE = new Pose(126.571, 67, Math.toRadians(0));
            static final Pose COLLECT2_OUT_POSE      = new Pose(100, 57, Math.toRadians(0));
            static final Pose COLLECT2_END_POSE      = new Pose(129, 57, Math.toRadians(0));
